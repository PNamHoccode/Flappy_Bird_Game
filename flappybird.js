...
backgroundImg1.src = "./image/bgs.jpg";

let backgroundImg2 = new Image();
backgroundImg2.src = "./image/bg3.jpg";

let backgroundImg3 = new Image();
backgroundImg3.src = "./image/bg2.jpg";

let backgroundImg4 = new Image();
backgroundImg4.src = "./image/bg4.jpg";
let currentBackgroundImg = backgroundImg1;
...
function update() {
  ...
  // Thay đổi background dựa trên điểm
  if (score >= 60) {
    ...
    currentBackgroundImg = backgroundImg1;
  }

  // Vẽ background
  context.drawImage(currentBackgroundImg, 0, 0, board.width, board.height);
